...
function WithMotion() {
  return (
    <section className="w-full relative top-[120px] py-20 px-[5%] grid gap-4">
      <div className="flex flex-col lg:flex-row items-center justify-center lg:items-end">
        <img src="/img/with-motion-left-image.png" alt="with-motion-left-image" className="w-full md:w-auto" />
        ...
        <div className="grid gap-4 bg-[#F3A14C] shadow-xl text-[#FFFFFF] py-16 px-10 rounded-3xl text-[16px] md:text-[18px]">
          <h3 className="text-3xl lg:text-4xl xl:text-5xl font-bold leading-tight text-right">With Motion <br /> Revive App</h3>
          <p className="text-right w-full md:w-[400px]"> You can easily plan your Goal with an easy
      ...
      <img src="/img/arrow-down.svg" alt="arrow-down" className="block lg:block xl:hidden" />
        <img src="/img/with-motion-down-image.png" alt="with-motion-down-image" className="w-full md:w-auto"/>
      </div>
    </section>
  )
}
